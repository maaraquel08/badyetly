...
import { CalendarCheck, CreditCard, Bell, ArrowRight, CheckCircle } from "lucide-react"
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
                  Track Your Monthly Dues <span className="text-primary">Effortlessly</span>
                </h1>
                <p className="text-muted-foreground text-lg md:text-xl max-w-[600px]">
                  Stay on top of your finances with our simple bill tracking system. Get reminders, visualize upcoming
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-muted-foreground text-lg max-w-[700px] mx-auto">
                Everything you need to stay on top of your bills and payments, without the complexity.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  title: "Calendar View",
                  description: "See all your bills in a monthly calendar layout. Never miss a due date again.",
                },
                {
                  icon: <Bell className="h-6 w-6" />,
                  title: "Smart Reminders",
                  description: "Get notified before bills are due. Customize when and how you receive reminders.",
                },
                {
                  icon: <CreditCard className="h-6 w-6" />,
                  title: "One-Click Payment",
                  description: "Mark bills as paid with a single click. Keep track of your payment history.",
                },
              ].map((feature, i) => (
                <div
                  key={i}
            ...
            <div className="rounded-2xl bg-primary/5 p-8 md:p-12 relative overflow-hidden">
              ...
              <div className="relative z-10 max-w-2xl mx-auto text-center">
                ...
                <p className="mt-4 text-muted-foreground text-lg mb-8">
                  Join thousands of users who never miss a payment with Monthly Dues Tracker.
                </p>
                <Link href="/signup">
                  <Button size="lg" className="rounded-full px-8">
