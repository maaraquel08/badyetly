...
DROP POLICY IF EXISTS "Users can view own monthly dues" ON monthly_dues;
DROP POLICY IF EXISTS "Users can insert own monthly dues" ON monthly_dues;
DROP POLICY IF EXISTS "Users can update own monthly dues" ON monthly_dues;
DROP POLICY IF EXISTS "Users can delete own monthly dues" ON monthly_dues;

-- Due instances policies
DROP POLICY IF EXISTS "Users can view own due instances" ON due_instances;
DROP POLICY IF EXISTS "Users can insert own due instances" ON due_instances;
DROP POLICY IF EXISTS "Users can update own due instances" ON due_instances;
DROP POLICY IF EXISTS "Users can delete own due instances" ON due_instances;

-- Recreate policies with improved syntax
-- Users table policies
